...
internal class Program
{
	...
	public static void RunPerformanceSample()
	{
		...
		// Insert at list 0
		{
			...
			sw.Stop();
			Console.WriteLine($"4A) Inserted into a list at index 0 for a total time of {sw.Elapsed}");
		}
		...
		// Insert at array end
		{
			...
			sw.Stop();
			Console.WriteLine($"4A) Inserted into an array at index {array.Length - 1} for a total time of {sw.Elapsed}");
		}
		...
		// Insert at list end
		{
			...
			sw.Stop();
			Console.WriteLine($"4A) Inserted into an list at index {list.Count - 1} for a total time of {sw.Elapsed}");
		}
	}
}